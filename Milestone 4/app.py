...
def visualizations():
    # Running the prediction and getting the visualizations
    demand_supply_gap_plot, risk_level_plot = run_prediction()

    # Render the visualizations page
    return render_template('visualizations.html', 
                           demand_supply_gap_plot=demand_supply_gap_plot, 
